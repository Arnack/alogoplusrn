...
@router.callback_query(Manager(), F.data.startswith('BackToApplications:'))
@router.callback_query(Manager(), F.data.startswith('ApplicationsByOrder:'))
...
@router.callback_query(Manager(), F.data.startswith('Application:'))
...
@router.callback_query(Manager(), F.data.startswith('ConfirmationApprove:'))
...
@router.callback_query(Manager(), F.data.startswith('ApproveApplication:'))
...
@router.callback_query(Manager(), F.data.startswith('ConfirmationReject:'))
...
@router.callback_query(Manager(), F.data.startswith('RejectApplication:'))
